...
/**
 * This shader is used to render the background (live stream) image.
 */
public class BackgroundShaderUtils {

    private static final String LOGTAG = "BackgroundShaderUtils";
