...
public class Matrix {
    ...
    public Matrix getInverse() {
        ...
        if (getNumberOfRows() == 3) {
            ...
            double h = get(2, 1);
            double i = get(2, 2);
            Matrix inverse = new Matrix(e * i - f * h, c * h - b * i, b * f - c * e, f * g - d * i, a * i - c * g,
    ...
    public static Matrix makeHomogenious(Matrix A) {
        ...
        return new Matrix(A.get(0, 0), A.get(0, 1), A.get(0, 2), 0, A.get(1, 0), A.get(1, 1), A.get(1, 2), 0, A.get(2, 0),
    ...
    public static Matrix createRotationMatrix3(Vector axis, double angle) {
        ...
        double t = 1.0 - c;
        return new Matrix(t * axis.get(0) * axis.get(0) + c, t * axis.get(0) * axis.get(1) - s * axis.get(2),
    ...
    public static Matrix createTranslationMatrix4(Vector translation) {
        return new Matrix(1, 0, 0, translation.x(), 0, 1, 0, translation.y(), 0, 0, 1, translation.z(), 0, 0, 0, 1);
    }

    /**
     * Create 3x3 identity.
     */
    public static Matrix createIdentityMatrix3() {
