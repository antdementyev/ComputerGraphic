...
Die Module haben die folgenden Abhängigkeiten:
...
\item In der \emph{build.gradle} des Moduls \emph{app} müssen die Zeilen zur Java8-Kompatibilität in der Version 2.3 einkommentiert werden.
\end{itemize}
