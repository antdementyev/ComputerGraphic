...
/**
 * Representation of a vector with arbitrary dimension.
 *
...
public class Vector implements Serializable {
    ...
    public static final Vector VECTOR_3_Z = new Vector(0, 0, 1);
     ...
     */
    public static Vector makeHomogenious(Vector v) {
        return new Vector(v.x(), v.y(), v.z(), 1);
    }
}
